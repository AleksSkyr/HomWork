public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Автор: " + theMountainsOfMadness.getAuthor().foolAuthor() + " Название книги: "
                + theMountainsOfMadness.getBookName() + " Изданна в: " + theMountainsOfMadness.setPublishingYear(1928));
        System.out.println("Автор: " + nineteenEightyFour.getAuthor().foolAuthor() + " Название книги: "
                + nineteenEightyFour.getBookName() + " Изданна в: " + nineteenEightyFour.setPublishingYear(1456));
